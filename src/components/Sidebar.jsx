                ...
                <div className="text-xl">
                    ...
                    <div>
                        <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer">
                            <svg className='w-5 fill-main' dataSlot="icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div className="group p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-secondary">
                            <svg className='w-5 fill-main group-hover:stroke-surface group-active:stroke-surface' dataSlot="icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div className="group p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-secondary active:bg-secondary">
                            <svg className='w-5 stroke-main group-hover:stroke-surface group-active:stroke-surface' dataSlot="icon" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <span className="text-[15px] ml-4 text-primary group-hover:text-surface group-active:text-surface">Settings</span>
                        </div>
                    </div>
                </div>
                <div className="">
                    ...
                    <div className="group p-2.5 mb-4 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-secondary">
                        <svg className='w-5 h-5 stroke-main group-hover:stroke-surface group-active:stroke-surface' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    ...
                    <div className="py-6">
                        <span className='text-sm font-bold'>©2024 - HAW</span>
                        <br />
